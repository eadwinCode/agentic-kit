 ...
 *  admin/migrate/sql/postgres/0004_run_settle_claim.sql, so the two record the same checksum
...
ALTER TABLE agentic_runs ADD COLUMN IF NOT EXISTS "settlingAt" TIMESTAMPTZ;
ALTER TABLE agentic_runs ADD COLUMN IF NOT EXISTS "settleToken" TEXT;
