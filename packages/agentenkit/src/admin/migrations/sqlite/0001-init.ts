 ...
 *  separate baseline step. SQLite has no ADD COLUMN IF NOT EXISTS, so the
 *  columns added after the first release are handled by the dialect's `repair`
 *  step, which runs before this file.
 *
